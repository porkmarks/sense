...
#define digitalWriteFast(P, V) BIT_WRITE(*__digitalPinToPortReg(P), __digitalPinToBit(P), (V))
#else
...
#ifndef pinModeFast
#if (defined(__AVR__) || defined(ARDUINO_ARCH_AVR))
#define pinModeFast(P, V) BIT_WRITE(*__digitalPinToDDRReg(P), __digitalPinToBit(P), (V))
#else
...
#if (defined(__AVR__) || defined(ARDUINO_ARCH_AVR))
#define digitalReadFast(P) ( (uint8_t) __digitalReadFast((P)) )
#define __digitalReadFast(P ) ( BIT_READ(*__digitalPinToPINReg(P), __digitalPinToBit(P)))
#else
