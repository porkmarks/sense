<div>
	<select id='country_id' name='country_id' class='mandatory'>
		...
		<option value='182' selected='selected'>Romania</option>
		<option value='183'>Russian Federation</option>
		<option value='184'>Rwanda</option>
		<option value='185'>Saint Bartelemey</option>
		...
		<option value='250'>Other country</option>
	</select>
</div>
